    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 space-y-5 shadow-xs">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
          ...
          <div className="flex items-center justify-between gap-2">
            <button
              ...
              className="h-8 w-8 rounded-lg bg-white border border-slate-200 shadow-xs flex items-center justify-center text-slate-700 hover:bg-slate-100 hover:border-slate-300 transition-colors"
            >
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
          ...
          <div className="flex items-center justify-center gap-1">
            <input
              ...
              className="w-12 bg-transparent text-center font-mono font-bold text-xl text-slate-900 border-b border-slate-300 focus:border-blue-600 focus:outline-none"
            />
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <span className={`font-mono font-bold text-2xl ${spo2 < 92 ? 'text-red-600' : 'text-slate-900'}`}>
              {spo2}%
            </span>
            <button
              type="button"
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <span className={`font-mono font-bold text-2xl ${gcs < 9 ? 'text-red-600' : 'text-slate-900'}`}>
              {gcs}
            </span>
            <button
              type="button"
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
        <div className="text-xs text-slate-500 flex items-center gap-2">
          ...
          <span>Recorded by <strong className="text-slate-700">{vitals.recordedBy}</strong> &middot; {vitals.recordedAt}</span>
        </div>
